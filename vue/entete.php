...
<body>
    ...
    <div class="sidebar hidden-print">
        <div class="logo-details">
            ...
            <img class="logo_name" src="../public/images/ExtraRoom.png" alt="" >


            <!-- <span class="logo_name">Extra Room</span> -->
        </div>
        <ul class="nav-links">
            <li>
    ...
    <section class="home-section">
        <nav class="hidden-print">
            ...
            <div class="profile-details">
                <!--<img src="images/ExtraRoom.png" alt="">-->
                <span class="admin_name">Dakouky</span>
